...
excerpt: "Designed angiogenic therapeutic peptides derived from visfatin using computational methods, and characterized the protein-peptide interaction using all-atom molecular dynamics simulations.<br/><img src='/images/research/Research_03.png' width='100%'>"
status: previous
collection: research
author_profile: true
---
...
<div style="text-align: center;">
  <img src="{{ base_path }}/images/research/Research_03_Fig1.png" width="60%">
...
<div style="text-align: center;">
  <img src="{{ base_path }}/images/research/Research_03_Fig2.png" width="75%">
...
<div style="text-align: center;">
  <img src="{{ base_path }}/images/research/Research_03_Fig3.png" width="50%">
...
<div style="text-align: center;">
  <img src="{{ base_path }}/images/research/Research_03_Fig4.png" width="60%">
